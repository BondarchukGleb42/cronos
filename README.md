...
`/start`, `/stop`, `/upgrade`, `/new`, `/chats`, `/delete`, `/clearall` — дополнительные короткие команды. Большая часть управления доступна свободным текстом. Голосовые сообщения и реальная оплата будут позже.
