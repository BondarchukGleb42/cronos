...
`/start`, `/stop`, `/upgrade` — дополнительные короткие команды. Большая часть управления доступна свободным текстом. Голосовые сообщения и реальная оплата будут позже.
